...
public class SpringJwtService implements IJwtService
{
    ...
    public String generateAccessToken(AppUser user)
    {
        ...
        if (userProfile != null)
        {
            ...
            claims.put("profileStrId", userProfile.getProfileStrId());
            claims.put("profileStrName", userProfile.getProfileStrName());
            claims.put("profileStrSigles", userProfile.getProfileStrSigles());
            claims.put("profileStrChaineSigles", userProfile.getProfileStrChaineSigles());
