package ci.dgmp.sigefbackend.admin.types.controller.repositories;
...
public interface TypeGroupRepo extends JpaRepository<TypeGroup, String> {
     ...
     */
    @Query("SELECT new ci.dgmp.sigefbackend.admin.types.model.dtos.TypeGroupDTO(tg.groupCode, tg.name) FROM TypeGroup tg")
    ...
    @Query("""
    select new ci.dgmp.sigefbackend.admin.types.model.dtos.TypeGroupDTO(t.groupCode, t.name) 
